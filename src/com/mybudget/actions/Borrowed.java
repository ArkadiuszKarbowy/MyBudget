...
import com.mybudget.database.BorrowerRecord;
import com.mybudget.database.Month;
import com.mybudget.database.Record;

public class Borrowed extends Fragment implements OnNewActionListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.borrowed, container,
				false);
		return rootView;
	}
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		View view = getView();
		name = (EditText) view.findViewById(R.id.borrowed_name_surname);
		note = (EditText) view.findViewById(R.id.borrowed_note);
		amount = (EditText) view.findViewById(R.id.borrowed_amount);
	...
	public Record onNewActionTaken(long idNote) {
		...
		return new BorrowerRecord(atrName, atrDescript, atrDate, atrAmount,
				idNote);
	}

	@Override
	public Month onUpdateSummaryElement(Month m, String state) {
		m.updateBorrowed(atrAmount, state);
		return m;
	}
}